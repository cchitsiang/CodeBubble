...
final class UpdateChecker: ObservableObject {
    ...
    private static let log = Logger(subsystem: "com.codebubble", category: "UpdateChecker")
    private let repo = "cchitsiang/CodeBubble"
    ...
    func performUpdate() {
        ...
        let dmgPath = NSTemporaryDirectory() + "CodeBubble-update.dmg"
        let mountPoint = "/tmp/codebubble-update-mount"
