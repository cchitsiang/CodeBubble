...
final class L10n: ObservableObject {
    ...
    private static let en: [String: String] = [
        ...
        "shortcut_togglePanel_desc": "Open or close the CodeBubble panel",
        ...
        "shortcut_accessibility_title": "Accessibility Permission Required",
        "shortcut_accessibility_desc": "Global shortcuts need Accessibility access to work when other apps are focused. Grant access in System Settings, then switch back here.",
        "shortcut_accessibility_open": "Open System Settings",
        "sessions": "Sessions",
        ...
        "boot_sound_desc": "Play a jingle when CodeBubble starts",
        ...
        "remote_hint": "The host field can be a normal hostname or an alias from your ~/.ssh/config. CodeBubble installs a small remote hook script and forwards events over SSH.",
        ...
        "update_available_body": "CodeBubble %@ is available (current: %@). Would you like to download it?",
        "download_update": "Download",
        "later": "Later",
        "no_update_title": "Up to Date",
        "no_update_body": "CodeBubble %@ is the latest version.",
        "ok": "OK",
        ...
        "update_homebrew_body": "CodeBubble %@ is available. Since you installed via Homebrew, please run:",
        "update_homebrew_command": "brew upgrade codebubble",
    ...
    private static let zh: [String: String] = [
        ...
        "shortcut_togglePanel_desc": "展开或收起 CodeBubble 面板",
        "shortcut_approve": "批准",
        ...
        "shortcut_accessibility_title": "需要辅助功能权限",
        "shortcut_accessibility_desc": "全局快捷键需要辅助功能权限才能在其他应用聚焦时工作。请在系统设置中授权，然后切回此处。",
        "shortcut_accessibility_open": "打开系统设置",
        "sessions": "会话",
        ...
        "system_section": "系统",
        "boot_sound": "启动音效",
        "boot_sound_desc": "CodeBubble 启动时播放提示音",
        "interaction": "交互",
        ...
        "remote_hint": "主机字段既可以填普通 hostname，也可以直接填 ~/.ssh/config 里的别名。CodeBubble 会在远端安装一个很小的 hook 脚本，并通过 SSH 转发事件回来。",
        "remote_connect": "连接",
        ...
        "update_available_body": "CodeBubble %@ 已发布（当前版本：%@），是否前往下载？",
        "download_update": "前往下载",
        "later": "稍后",
        "no_update_title": "已是最新版本",
        "no_update_body": "CodeBubble %@ 已是最新版本。",
        "ok": "好",
        "update_now": "立即更新",
        ...
        "update_homebrew_body": "CodeBubble %@ 已发布。由于您通过 Homebrew 安装，请运行：",
        "update_homebrew_command": "brew upgrade codebubble",
